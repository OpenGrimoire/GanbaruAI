...
- **Agent runs:** bounded execution attempts permanently linked to one project, one folder or private-scratch execution target, one immutable teammate policy revision, one revisioned authorization decision, one provider turn, and optionally one hidden provider thread.
