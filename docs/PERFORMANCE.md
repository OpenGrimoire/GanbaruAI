...
The unrecorded `dense-chat-v1` fixture seeds project working folders and non-null project-owned threads directly. It does not create rows for the removed `chat_workspaces` model. Its version remains unchanged because no comparable benchmark row has been recorded for this fixture shape.
