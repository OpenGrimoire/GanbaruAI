...
The user-facing workspace behavior, lifecycle, recovery states, and data ownership rules live in [Chat](chat.md). This document keeps the provider and AI-surface architecture.
