...
#[derive(Clone)]
pub(super) struct SnapshotMaterial {
    pub(super) before_oid: String,
    pub(super) after_oid: String,
    pub(super) label: String,
    pub(super) status: git_service::GitStatusRead,
...
pub(super) type ReviewNumstat = BTreeMap<String, (Option<u64>, Option<u64>)>;

pub(super) async fn working_tree_material(
    root: &Path,
...
pub(super) fn enrich_working_tree_files(
...
pub(super) fn deterministic_diff_arguments(
    ignore_whitespace: bool,
