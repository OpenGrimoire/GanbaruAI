...
pub(crate) struct ProviderTurnReservationHandoff {
    inner: Arc<ChatWorkspaceMutationRegistryInner>,
    key: String,
    active: bool,
}

pub(crate) struct ThreadReservationCleanup {
    inner: Arc<ChatWorkspaceMutationRegistryInner>,
...
impl ChatWorkspaceMutationRegistry {
    ...
    pub(crate) fn thread_cleanup(&self, thread_id: &ChatThreadId) -> ThreadReservationCleanup {
...
impl PendingProviderTurnReservation {
    pub(crate) fn handoff_to_runtime(mut self) -> ChatResult<ProviderTurnReservationHandoff> {
...
impl ProviderTurnReservationHandoff {
    pub(crate) fn handoff_to_event_sink(mut self) {
