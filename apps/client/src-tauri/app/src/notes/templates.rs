...
pub(in crate::notes) async fn list_page_templates(
    pool: &SqlitePool,
...
pub(in crate::notes) async fn create_page_template_from_page(
    pool: &SqlitePool,
...
pub(in crate::notes) async fn apply_page_template(
    pool: &SqlitePool,
    template_id: &str,
...
pub(in crate::notes) async fn update_page_template(
    pool: &SqlitePool,
    template_id: &str,
...
pub(in crate::notes) async fn duplicate_page_template(
    pool: &SqlitePool,
    template_id: &str,
...
pub(in crate::notes) async fn delete_page_template(
    pool: &SqlitePool,
    template_id: &str,
...
impl_sqlite_from_row!(SourcePageSnapshot {
    properties,
    icon,
    cover,
});
