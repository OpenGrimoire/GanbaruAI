...
pub(in crate::notes) const NOTE_BLOCK_CATALOG_BLOCKED_FUTURE_TYPES: &[&str] =
    &["meeting_notes", "transcription"];
pub(in crate::notes) const NOTE_BLOCK_CATALOG_GATE_REQUIREMENTS: &[&str] = &[
...
pub(in crate::notes) fn block_catalog_gate_error(block_type: &str) -> String {
