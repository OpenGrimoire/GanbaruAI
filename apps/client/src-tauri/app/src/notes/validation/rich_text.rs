...
pub(in crate::notes) fn validate_rich_text_item(value: &Value) -> Result<(), String> {
    let object = value
        .as_object()
...
pub(in crate::notes) fn validate_text_rich_text_item(
...
pub(in crate::notes) fn validate_equation_rich_text_item(
    object: &serde_json::Map<String, Value>,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_mention_rich_text_item(
    object: &serde_json::Map<String, Value>,
) -> Result<(), String> {
    let mention = object
        .get("mention")
...
pub(in crate::notes) fn validate_page_mention(
...
pub(in crate::notes) fn validate_user_mention(
    mention: &serde_json::Map<String, Value>,
) -> Result<(), String> {
    let user_id = mention
        .get("user")
...
pub(in crate::notes) fn validate_database_mention(
    mention: &serde_json::Map<String, Value>,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_ganbaru_object_mention(
    mention: &serde_json::Map<String, Value>,
) -> Result<(), String> {
    let object = mention
        .get("ganbaru_object")
...
pub(in crate::notes) fn validate_ganbaru_object_id(value: &str, field: &str) -> Result<(), String> {
...
pub(in crate::notes) fn validate_date_mention(
    mention: &serde_json::Map<String, Value>,
) -> Result<(), String> {
    let date = mention
        .get("date")
...
pub(in crate::notes) fn validate_date_mention_reminder(value: &Value) -> Result<(), String> {
    if value.is_null() {
        return Ok(());
    }
    let reminder = value
...
pub(in crate::notes) fn validate_date_mention_boundary(
    value: &str,
    field: &str,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_inline_equation_expression(
    value: &str,
    field: &str,
) -> Result<(), String> {
    if value.trim().is_empty() || contains_control_characters(value) {
...
pub(in crate::notes) fn date_mention_boundary_looks_iso(value: &str) -> bool {
...
pub(in crate::notes) fn two_digit_number(tens: u8, ones: u8) -> u8 {
    (tens - b'0') * 10 + (ones - b'0')
}

pub(in crate::notes) fn validate_rich_text_common_fields(
    object: &serde_json::Map<String, Value>,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_rich_text_url(value: &str, field: &str) -> Result<(), String> {
    if value.trim().is_empty() || contains_control_characters(value) {
        return Err(format!(
            "{field} must not be empty or contain control characters"
        ));
...
pub(in crate::notes) fn is_email_address_like(value: &str) -> bool {
...
pub(in crate::notes) fn validate_optional_color(
    payload: &Value,
    field: &str,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_required_color(
    value: Option<&Value>,
    field: &str,
) -> Result<(), String> {
    match value {
