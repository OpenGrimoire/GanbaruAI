...
pub(super) async fn probe_bitbucket(
...
pub(super) async fn bitbucket_list_change_requests(
    repository_slug: &str,
    limit: u32,
...
pub(super) async fn bitbucket_create_change_request(
...
pub(super) fn parse_bitbucket_change_request(value: &Value) -> ChatResult<HostedChangeRequestRead> {
...
pub(super) async fn bitbucket_authenticated_request(
...
pub(super) fn bitbucket_credential_reference(
    repository_slug: &str,
) -> ChatResult<CredentialReferenceId> {
...
pub(super) fn percent_encode_segment(value: &str) -> String {
...
pub(super) fn credential_error() -> ChatError {
    ChatError::new(
