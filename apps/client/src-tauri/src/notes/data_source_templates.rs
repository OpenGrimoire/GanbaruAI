...
pub(in crate::notes) async fn list_data_source_templates(
    pool: &SqlitePool,
    data_source_id: &str,
...
pub(in crate::notes) async fn create_data_source_template_from_row(
    pool: &SqlitePool,
    data_source_id: &str,
...
pub(in crate::notes) async fn apply_data_source_template(
    pool: &SqlitePool,
    data_source_id: &str,
    template_id: &str,
...
pub(in crate::notes) async fn update_data_source_template(
    pool: &SqlitePool,
    data_source_id: &str,
    template_id: &str,
...
pub(in crate::notes) async fn duplicate_data_source_template(
    pool: &SqlitePool,
    data_source_id: &str,
    template_id: &str,
...
pub(in crate::notes) async fn delete_data_source_template(
    pool: &SqlitePool,
    data_source_id: &str,
    template_id: &str,
