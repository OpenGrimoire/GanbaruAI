...
fn validate_external_icon_url(url: &str, field: &str) -> Result<(), String> {
...
fn validate_file_icon(file: &serde_json::Map<String, Value>, field: &str) -> Result<(), String> {
