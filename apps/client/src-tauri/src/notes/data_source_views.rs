...
pub(in crate::notes) fn validate_view_scope(
    data_source_id: &str,
...
pub(in crate::notes) fn scoped_database_id<'a>(
...
pub(in crate::notes) async fn next_view_sort_order_tx(
...
pub(in crate::notes) async fn load_scoped_view_row_tx(
    tx: &mut Transaction<'_, Sqlite>,
    data_source_id: &str,
    view_type: &str,
    database_id: Option<&str>,
