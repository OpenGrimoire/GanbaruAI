...
pub(in crate::notes) fn validate_json_object(value: &Value, field: &str) -> Result<(), String> {
    if value.is_object() {
        Ok(())
    } else {
...
pub(in crate::notes) fn validate_empty_object_payload(
    value: &Value,
    field: &str,
) -> Result<(), String> {
    let object = value
...
pub(in crate::notes) fn validate_table_of_contents_payload(payload: &Value) -> Result<(), String> {
    validate_optional_color(payload, "table_of_contents.color")
}

pub(in crate::notes) fn validate_child_page_payload(payload: &Value) -> Result<(), String> {
...
pub(in crate::notes) fn validate_child_database_payload(payload: &Value) -> Result<(), String> {
    match payload.get("title") {
...
pub(in crate::notes) fn validate_optional_payload_uuid(
    payload: &Value,
    key: &str,
    field: &str,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_column_payload(payload: &Value) -> Result<(), String> {
...
pub(in crate::notes) fn validate_table_payload(payload: &Value) -> Result<(), String> {
...
pub(in crate::notes) fn validate_table_row_payload(payload: &Value) -> Result<(), String> {
...
pub(in crate::notes) fn validate_synced_block_payload(payload: &Value) -> Result<(), String> {
...
pub(in crate::notes) fn validate_equation_payload(payload: &Value) -> Result<(), String> {
...
pub(in crate::notes) fn validate_unsupported_payload(payload: &Value) -> Result<(), String> {
...
pub(in crate::notes) fn validate_optional_display_string(
    value: Option<&Value>,
    field: &str,
) -> Result<(), String> {
    match value {
...
pub(in crate::notes) fn contains_control_characters(value: &str) -> bool {
    value
        .chars()
        .any(|character| character.is_control() && character != '\n' && character != '\t')
}

pub(in crate::notes) fn validate_rich_text_payload(
    payload: &Value,
    field: &str,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_optional_paragraph_icon(
    payload: &Value,
    field: &str,
) -> Result<(), String> {
    if field != "paragraph" {
...
pub(in crate::notes) fn validate_template_payload(payload: &Value) -> Result<(), String> {
...
pub(in crate::notes) fn validate_button_payload(payload: &Value) -> Result<(), String> {
    if payload.get("children").is_some() {
...
pub(in crate::notes) fn validate_button_action(action: &Value, index: usize) -> Result<(), String> {
...
pub(in crate::notes) fn validate_callout_icon(payload: &Value, field: &str) -> Result<(), String> {
    if field != "callout" {
        return Ok(());
    }
    match payload.get("icon") {
...
pub(in crate::notes) fn validate_optional_toggle_open(
    payload: &Value,
    field: &str,
) -> Result<(), String> {
    if field != "toggle" {
...
pub(in crate::notes) fn validate_optional_heading_toggle_fields(
    payload: &Value,
    field: &str,
) -> Result<(), String> {
