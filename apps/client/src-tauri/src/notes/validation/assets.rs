...
pub(in crate::notes) fn validate_cover_file_object(
...
pub(in crate::notes) fn validate_icon_object(
...
pub(in crate::notes) fn validate_custom_emoji_icon(
...
pub(in crate::notes) fn validate_external_icon_url(url: &str, field: &str) -> Result<(), String> {
...
pub(in crate::notes) fn validate_file_icon(
    file: &serde_json::Map<String, Value>,
    field: &str,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_native_icon(
    icon: &serde_json::Map<String, Value>,
    field: &str,
) -> Result<(), String> {
    let native = icon
...
pub(in crate::notes) fn validate_local_image_metadata(
    file: &serde_json::Map<String, Value>,
    field: &str,
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_optional_non_empty_string(
    value: Option<&Value>,
    field: &str,
) -> Result<(), String> {
    match value {
...
pub(in crate::notes) fn validate_optional_icon_url(
    value: Option<&Value>,
    field: &str,
    asset_prefixes: &[&str],
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_optional_asset_path(
    value: Option<&Value>,
    field: &str,
    prefixes: &[&str],
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_managed_image_asset_path(
    path: &str,
    field: &str,
    prefixes: &[&str],
) -> Result<(), String> {
...
pub(in crate::notes) fn validate_remote_icon_file_url(
    url: &str,
    field: &str,
) -> Result<(), String> {
    let parsed =
...
pub(in crate::notes) fn has_supported_image_extension(path: &str) -> bool {
...
pub(in crate::notes) fn is_sha256_hex(value: &str) -> bool {
    value.len() == 64
        && value
            .bytes()
