...
pub(in crate::notes) async fn add_page_alias(
    pool: &SqlitePool,
    page_id: &str,
...
pub(in crate::notes) async fn delete_page_alias(
    pool: &SqlitePool,
    page_id: &str,
    alias_id: &str,
) -> Result<Vec<NotePageAliasDto>, String> {
...
pub(in crate::notes) async fn list_unresolved_links(
    pool: &SqlitePool,
    page_id: &str,
...
pub(in crate::notes) async fn resolve_unresolved_link(
    pool: &SqlitePool,
    link_id: &str,
...
pub(in crate::notes) async fn rebuild_unresolved_index(pool: &SqlitePool) -> Result<i64, String> {
