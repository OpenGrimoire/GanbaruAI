...
pub(in crate::notes) async fn list_suggestions(
    pool: &SqlitePool,
    page_id: &str,
...
pub(in crate::notes) async fn create_suggestion(
    pool: &SqlitePool,
...
pub(in crate::notes) async fn accept_suggestion(
    pool: &SqlitePool,
    suggestion_id: &str,
) -> Result<NoteSuggestionDto, String> {
...
pub(in crate::notes) async fn reject_suggestion(
    pool: &SqlitePool,
    suggestion_id: &str,
) -> Result<NoteSuggestionDto, String> {
