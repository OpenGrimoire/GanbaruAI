...
pub(in crate::notes) struct PropertySearchEntry {
    ...
    pub(in crate::notes) body: String,
    pub(in crate::notes) metadata: String,
    pub(in crate::notes) source_last_edited_time: String,
}

pub(in crate::notes) async fn property_search_entries(
    pool: &SqlitePool,
