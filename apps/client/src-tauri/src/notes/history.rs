...
pub(in crate::notes) async fn get_page_history_settings(
    pool: &SqlitePool,
...
pub(in crate::notes) async fn update_page_history_settings(
    pool: &SqlitePool,
...
pub(in crate::notes) async fn list_page_history_snapshots(
    pool: &SqlitePool,
    page_id: &str,
...
pub(in crate::notes) async fn load_page_history_snapshot(
    pool: &SqlitePool,
    page_id: &str,
    snapshot_id: &str,
...
pub(in crate::notes) async fn restore_page_history_snapshot(
    pool: &SqlitePool,
    page_id: &str,
    snapshot_id: &str,
) -> Result<NoteLoadedPage, String> {
...
pub(in crate::notes) async fn copy_page_history_blocks(
    pool: &SqlitePool,
    page_id: &str,
    snapshot_id: &str,
...
pub(in crate::notes) async fn record_page_snapshot_tx(
