...
export const PROJECT_TASK_LIST_COLUMNS = ["status", "priority", "estimate", "due", "scheduled", "dependencies"] as const;
...
export const PROJECT_TEMPLATE_DEFAULTS = {
  ...
  course: {
    ...
    color: null,
    defaultEventDurationMinutes: 60,
    defaultPomodoroPresetKey: "balanced",
    defaultIdleTimeoutMinutes: 5,
  },
  routine: {
    icon: "repeat",
