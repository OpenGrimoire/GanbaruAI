...
<div class="flex items-center justify-between gap-2">
  <h2 class="text-[0.8rem] font-semibold tracking-normal">{t("projects.detail.subtasks")}</h2>
  <span class="text-[0.733333rem] text-muted-foreground">{subtasks.length}</span>
</div>
