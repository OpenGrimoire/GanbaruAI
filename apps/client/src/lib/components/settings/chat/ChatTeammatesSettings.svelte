...
<style>
  ...
  nav { min-height:24rem; border-right:1px solid var(--border); padding:0.4rem; } nav > p { padding:1rem; color:var(--muted-foreground); font-size: calc(0.75rem * var(--type-scale)); } nav > button { display:grid; width:100%; grid-template-columns:auto minmax(0,1fr) auto; gap:0.2rem 0.5rem; align-items:center; border-radius:0.45rem; padding:0.45rem; text-align:left; } nav > button.active { background:var(--accent); } nav > button > span { display:grid; min-width:0; } nav strong,nav small { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; } nav strong { font-size: calc(0.76rem * var(--type-scale)); } nav small { color:var(--muted-foreground); font-size: calc(0.64rem * var(--type-scale)); } nav i { border-radius:999px; background:var(--accent); padding:0.1rem 0.3rem; color:var(--muted-foreground); font-size: calc(0.58rem * var(--type-scale)); font-style:normal; } nav i[data-state="healthy"] { color:var(--action-confirm); } nav > button > small:last-child { grid-column:2; }
  .teammate-editor { display:grid; align-content:start; gap:0.85rem; padding:1rem; }.editor-heading { display:flex; align-items:start; gap:0.55rem; }.editor-heading h3 { font-size: calc(0.86rem * var(--type-scale)); font-weight:600; }.editor-heading p { margin-top:0.15rem; color:var(--muted-foreground); font-size: calc(0.7rem * var(--type-scale)); }
  .field-grid { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:0.65rem; }.field-grid label { display:grid; align-content:start; gap:0.3rem; color:var(--muted-foreground); font-size: calc(0.68rem * var(--type-scale)); font-weight:500; }.field-grid label.full { grid-column:1/-1; }.field-grid input,.field-grid textarea { min-width:0; border:1px solid var(--border); border-radius:0.4rem; background:var(--background); padding:0.4rem 0.5rem; color:var(--foreground); outline:none; font-weight:400; }.field-grid textarea { resize:vertical; }.handle-input { display:flex; align-items:center; border:1px solid var(--border); border-radius:0.4rem; background:var(--background); padding-left:0.45rem; }.handle-input input { border:0; background:transparent; }
  fieldset { display:grid; gap:0.35rem; } legend { color:var(--muted-foreground); font-size: calc(0.68rem * var(--type-scale)); font-weight:500; }.folder-grants { display:flex; flex-wrap:wrap; gap:0.35rem; }.folder-grants label { display:flex; align-items:center; gap:0.3rem; border:1px solid var(--border); border-radius:999px; padding:0.25rem 0.45rem; font-size: calc(0.68rem * var(--type-scale)); }.folder-grants small { color:var(--muted-foreground); }
  .grant-review { border:1px solid color-mix(in srgb,var(--primary) 24%,var(--border)); border-radius:0.5rem; background:color-mix(in srgb,var(--primary) 5%,transparent); padding:0.65rem; }.grant-review h4 { font-size: calc(0.72rem * var(--type-scale)); font-weight:600; }.grant-review ul { display:grid; gap:0.25rem; margin-top:0.4rem; }.grant-review li { display:flex; align-items:start; gap:0.35rem; color:var(--muted-foreground); font-size: calc(0.68rem * var(--type-scale)); }.grant-review li :global(svg) { flex:0 0 auto; color:var(--action-confirm); }
  footer { display:flex; align-items:center; gap:0.5rem; } footer span { flex:1; }.archive-button { display:flex; align-items:center; gap:0.3rem; color:var(--destructive); font-size: calc(0.7rem * var(--type-scale)); }.form-error { color:var(--destructive); font-size: calc(0.7rem * var(--type-scale)); }.saved { color:var(--action-confirm); font-size: calc(0.7rem * var(--type-scale)); }
