...
const document: MusicInterchangeDocument = {
  ...
  playlists: [{ id: "playlist-1", name: "Focus", description: "", shuffleEnabled: true, repeatMode: "all", intendedUses: ["focus"], memberships: [{ item: { identityKey: "youtube:abc123", sourceKind: "youtube-video", youtubeVideoId: "abc123", title: "Track", artist: "", album: "", durationMs: null, signals: ["lyrics"], locations: [] }, position: 0, weight: "normal", enabled: true, focusFit: "potentially-distracting", startMs: null, endMs: null, volume: null, rate: null, skipRanges: [], snoozes: [] }] }],
