export const configuration = {
  settings: {
    ...
    workingFolders: {
      ...
      description: "Chat and file-backed Notes work inside these folders. Every project keeps a private managed folder in the current Ganbaru AI folder.",
      managed: "Managed",
      external: "External",
      archived: "Archived",
      primary: "Primary",
      makePrimary: "Make primary",
      primaryUnavailable: "The project primary working folder is not available yet.",
      statusAvailable: "Available on this device",
      statusMissing: "Folder is missing",
      statusRepositoryMismatch: "Repository identity changed",
      statusUnbound: "Not located on this device",
      ...
      rebind: "Rebind",
      rename: "Rename",
      renamePrompt: "Working folder name",
      archive: "Archive",
      restore: "Restore",
      remove: "Remove from project",
      removeConfirm: (name: string) => `Remove ${name} from this project? Files on disk will not be deleted.`,
      addExisting: "Add existing folder",
      pickerTitle: "Choose a project working folder",
    },
