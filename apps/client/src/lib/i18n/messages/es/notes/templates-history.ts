...
export const templatesHistory = {
  ...
  pageHistoryReason: {
    createChildPage: "Nueva nota anidada",
    createChildPageFromBlock: "Bloque convertido en nota",
    duplicatePage: "Nota duplicada",
    movePage: "Nota movida",
    updatePage: "Detalles de nota",
    trashPage: "Nota movida a la papelera",
