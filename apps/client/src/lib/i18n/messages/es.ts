...
export const es = {
  ...
  projects: {
    ...
    toolbar: {
      ...
      settingsPanelSubtitle: "Predeterminados, estados de tarea, etiquetas y campos",
      none: "Ninguna",
    ...
    settings: {
      ...
      newLabelPlaceholder: "Nueva etiqueta...",
      noLabels: "No hay etiquetas del proyecto",
      selectLabelColor: (label: string) => `Seleccionar color para ${label}`,
      selectNewLabelColor: "Seleccionar color para la etiqueta nueva",
      labelNameRequired: "El nombre de la etiqueta es obligatorio.",
      labelNameExists: "Ya existe una etiqueta con ese nombre.",
      labelSaveFailed: (message: string) => `No se pudo guardar la etiqueta: ${message}`,
      labelDeleteFailed: (message: string) => `No se pudo eliminar la etiqueta: ${message}`,
      deleteLabelTitle: (label: string) => `¿Eliminar ${label}?`,
      deleteLabelMessage: (label: string) =>
    ...
    detail: {
      ...
      createLabel: (name: string) => `Crear ${name}`,
      noLabelCandidates: "No hay etiquetas para agregar",
    ...
    actions: {
      ...
      removeLabel: (label: string) => `Quitar etiqueta ${label}`,
      moveLabelUp: (label: string) => `Subir etiqueta ${label}`,
      moveLabelDown: (label: string) => `Bajar etiqueta ${label}`,
      deleteLabel: (label: string) => `Eliminar etiqueta ${label}`,
