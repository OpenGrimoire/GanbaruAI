...
export const es = {
  ...
  projects: {
    ...
    settings: {
      ...
      defaults: "Predeterminados de programación",
      defaultDuration: "Minutos de duración predeterminada",
      ...
      invalidDuration: "La duración predeterminada debe ser un número entero positivo.",
