...
export const es = {
  ...
  projects: {
    ...
    settings: {
      ...
      deleteStatusBlockedLast: "El proyecto debe conservar al menos un estado de flujo",
      ...
      statusReorderFailed: "No se pudo reordenar el estado del flujo.",
      deleteStatusTitle: (status: string) => `¿Eliminar ${status}?`,
      deleteStatusMessage: (status: string) =>
        `Esto quita ${status} del flujo de este proyecto. Solo se pueden eliminar estados sin tareas.`,
