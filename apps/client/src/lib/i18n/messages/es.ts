...
export const es = {
  ...
  notes: {
    ...
    blockUnreadCommentsCount: (unread: number, count: number) =>
      `${unread} sin leer de ${count} ${
        count === 1 ? "comentario de bloque" : "comentarios de bloque"
      }`,
    ...
    addPageIcon: "Agregar icono de página",
    changePageIcon: "Cambiar icono de página",
    removePageIcon: "Quitar icono de página",
    ...
    permanentDeleteConfirmMessage:
      "Esto elimina permanentemente la página, sus subpáginas y sus bloques. No se puede deshacer.",
