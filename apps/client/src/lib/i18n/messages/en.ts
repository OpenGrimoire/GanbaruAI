export const en = {
  ...
  projects: {
    ...
    toolbar: {
      ...
      default: "Default",
      settingsPanelSubtitle: "Defaults, task statuses, labels, and fields",
      none: "None",
    ...
    settings: {
      ...
      noLabels: "No project labels",
      selectLabelColor: (label: string) => `Select color for ${label}`,
      selectNewLabelColor: "Select color for new label",
      labelNameRequired: "Label name is required.",
      labelNameExists: "A label with that name already exists.",
      labelSaveFailed: (message: string) => `Could not save label: ${message}`,
      labelDeleteFailed: (message: string) => `Could not delete label: ${message}`,
      deleteLabelTitle: (label: string) => `Delete ${label}?`,
    ...
    detail: {
      ...
      noLabelCandidates: "No labels to add",
    ...
    actions: {
      ...
      removeLabel: (label: string) => `Remove label ${label}`,
      moveLabelUp: (label: string) => `Move label ${label} up`,
      moveLabelDown: (label: string) => `Move label ${label} down`,
      deleteLabel: (label: string) => `Delete label ${label}`,
