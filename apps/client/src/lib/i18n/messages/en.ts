export const en = {
  ...
  projects: {
    ...
    settings: {
      ...
      deleteStatusBlockedLast: "Project must keep at least one workflow status",
      ...
      statusReorderFailed: "Could not reorder workflow status.",
      deleteStatusTitle: (status: string) => `Delete ${status}?`,
      deleteStatusMessage: (status: string) =>
        `This removes ${status} from this project's workflow. Only statuses with no tasks can be deleted.`,
