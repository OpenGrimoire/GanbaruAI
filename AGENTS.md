    ...
    src/: Svelte frontend
      lib/: shared frontend code
        components/: reusable Svelte components
          ...
          chat/: local coding-agent shell, first-use states, navigation, archive, and conversation header
